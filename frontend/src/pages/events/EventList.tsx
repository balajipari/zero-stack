  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[#FCFAF7] flex items-center justify-center">
        <div className="text-xl text-[#6D666F]">Loading events...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-[#FCFAF7]">
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="text-center mb-16">
          <h1 className="text-5xl font-bold text-[#232B36] mb-6">All Events</h1>
          <p className="text-xl text-[#6D666F] max-w-2xl mx-auto">
            Browse and register for upcoming events, workshops, and networking sessions.
          </p>
        </section>

        <section className="mb-16" aria-labelledby="events-heading">
          <h2 id="events-heading" className="text-3xl font-bold text-[#232B36] mb-8">Events</h2>
